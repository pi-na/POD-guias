...
public class PubSubTest {
    ...
    private final int poisonPillPerProducer = N_CONSUMERS / N_PRODUCERS;    // necesito poisonPillPerProducer para asegurar
                                                                            // que genere suficientes poisonPill para todos los consumer
    private final int mod = N_CONSUMERS % N_PRODUCERS;  // Necesito sumar MOD pq necesito que N_Producer y N_Consumer tengan MCM
